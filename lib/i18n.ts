...
const en = {
  ...
  landing: {
    ...
    searchPlaceholder: "A booking site for my restaurant…",
    searchAction: "Find a starting point",
    intentHint: "Describe what you are building. Your words come with you into Kodu.",
  ...
  gallery: {
    ...
    intentHeading: "Starting points for what you described",
    intentQuote: "You wrote: “{intent}”",
    intentNote: "Open any of these and Kodu starts with your description already in hand.",
    intentEmpty: "Nothing here matches that yet. Try describing it differently, or browse everything.",
    showAll: "Browse all templates",
  },
  detail: {
    ...
    withIntent: "Kodu will open this with your description: “{intent}”",
    tryItLive: "Try it live",
    whatsInside: "What's inside",
    stale: "Not touched in over a year. Check it still installs before you build on it.",
    dependencies: "{count} direct dependencies",
    aboutTemplate: "About this template",
    features: "What it includes",
    summaryCredit: "From the project's README, written by its authors.",
    roleFramework: "Framework",
    roleStyling: "Styling",
    roleUi: "Components",
    roleDatabase: "Database",
    roleAuth: "Auth",
    rolePayments: "Payments",
    roleTesting: "Testing",
    roleContent: "Content",
    tryItNote: "Runs the real demo here, in the page.",
    showScreenshot: "Show the screenshot",
    liveNote: "This is the template's own demo, running.",
...
const mn: Dictionary = {
  ...
  landing: {
    ...
    searchPlaceholder: "Ресторандаа ширээ захиалдаг сайт…",
    searchAction: "Эхлэх цэгээ олох",
    intentHint: "Юу барихаа бичээрэй. Бичсэн зүйл чинь Kodu руу хамт очно.",
  ...
  gallery: {
    ...
    resultsHeading: "Үр дүн",
    intentHeading: "Таны бичсэнд тохирох эхлэлүүд",
    intentQuote: "Та бичсэн: «{intent}»",
    intentNote: "Аль нэгийг нь нээхэд Kodu таны тайлбарыг аль хэдийн гартаа авсан байна.",
    intentEmpty: "Одоохондоо тохирох зүйл олдсонгүй. Өөрөөр тайлбарлаж үзэх, эсвэл бүгдийг үзнэ үү.",
    showAll: "Бүх template үзэх",
  },
  detail: {
    ...
    withIntent: "Kodu үүнийг таны тайлбартай хамт нээнэ: «{intent}»",
    tryItLive: "Амьдаар нь үзэх",
    whatsInside: "Юу орсон бэ",
    stale: "Нэг жил гаруй хөндөгдөөгүй. Дээр нь барихаасаа өмнө суух эсэхийг шалгаарай.",
    dependencies: "{count} шууд dependency",
    aboutTemplate: "Энэ template-ийн тухай",
    features: "Юу багтсан бэ",
    summaryCredit: "Төслийн README-гээс, зохиогчдынх нь бичсэнээр.",
    roleFramework: "Framework",
    roleStyling: "Загвар",
    roleUi: "Компонент",
    roleDatabase: "Өгөгдлийн сан",
    roleAuth: "Нэвтрэлт",
    rolePayments: "Төлбөр",
    roleTesting: "Тест",
    roleContent: "Контент",
    tryItNote: "Жинхэнэ демог энэ хуудсан дээр ажиллуулна.",
    showScreenshot: "Зургийг харуулах",
    liveNote: "Энэ бол template-ийн өөрийнх нь демо, ажиллаж байна.",
